...
bool Session::initialize()
{
    ...
    case StreamingPreferences::VCC_AUTO:
    {
        ...
        auto hevcDA = getDecoderAvailability(testWindow,
                                             ...
                                             m_Preferences->enableYUV444 ? (m_Preferences->enableHdr ? VIDEO_FORMAT_H265_REXT10_444 : VIDEO_FORMAT_H265_REXT8_444) : (m_Preferences->enableHdr ? VIDEO_FORMAT_H265_MAIN10 : VIDEO_FORMAT_H265),
                                             m_StreamConfig.width,
                                             m_StreamConfig.height,
                                             m_StreamConfig.fps);
