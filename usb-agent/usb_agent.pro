...
!contains(DEFINES, MOONLIGHT_REMOTE_USB_LIBUSB): \
    warning("libusb was not found. moonlight-usb-agent will build without USB device access. Set MOONLIGHT_REMOTE_USB_LIBUSB_INCLUDE_DIR and MOONLIGHT_REMOTE_USB_LIBUSB_LIBRARY.")
